...
export default {
  ...
  methods: {
    ...
    tokenCompliance() {
      ...
      return (details.length === 0) ? "No compliance features were selected." : "The following compliance features were selected: " + details + ".";
    },
    tokenDetails() {
      let details = (this.fractional === "yes") ? "It will be fractional with " + this.decimals + " decimals " : "It will be non-fractional ";
